...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-03-26T22:28:10.862818" />
  ...
  <link href="/media/css/fontawesome.css?50ef8dd6" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="/favicon.ico" />
    ...
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?50ef8dd6">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/translations-of-code-of-conduct-posted-japanese-hebrew-and-russian-2185/">Translations of Code of Conduct Posted: Japanese, Hebrew, and Russian</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-03-26 by PostgreSQL Code of Conduct Committee</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v51-released-2188/">pgAdmin 4 v5.1 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-03-25 by pgAdmin Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-march-21-2021-2186/">PostgreSQL Weekly News - March 21, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-03-22 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-community-code-of-conduct-committee-annual-report-for-2020-2184/">PostgreSQL Community Code of Conduct Committee Annual Report for 2020</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-03-16 by PostgreSQL Code of Conduct Committee</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-march-14-2021-2183/">PostgreSQL Weekly News - March 14, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-03-15 by PWN</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/52c"> Faster Bulk Insertion to Foreign Tables - Introduction to PostgreSQL 14 Committe</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Takayuki Tsunakawa</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-03-26</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/52b"> Speeding up recovery &amp; VACUUM in Postgres 14</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Rowley</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-03-25</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/52a"> Physical Backup Privileges Check</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/529"> A first look at pg_repack</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Luca Ferrari</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-03-25</li>
            </ul>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/527"> Performance Improvements in GEOS</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Paul Ramsey</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-03-24</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/51-"> How the PostgreSQL query optimizer works</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/51Y"> Waiting for PostgreSQL 14 – Allow configurable LZ4 TOAST compression.</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#39;depesz&#39; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-03-22</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/51X"> Getting Started with EXPLAIN (ANALYZE)</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/51Z"> Julien Riou</a></h3>
            <ul class="meta">
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?50ef8dd6"></script>
